    ...
    <div className="px-4 py-16">
      ...
      <div className="my-5">
        ...
        <div className="rounded-md relative flex items-center shadow-sm">
          ...
          <input
            id="price"
            className="appearance-none pl-7 w-full px-3 py-2 border-gray-500 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
            type="text"
            placeholder="0.00"
          />
      ...
      <div>
        ...
        <textarea
          className="mt-1 shadow-md w-full focus:ring-orange-500 rounded-md border-gray-300 focus:border-orange-500"
          rows={4}
        />
      </div>
