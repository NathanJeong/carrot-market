    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-16">
        <div className="flex flex-col items-center">
          <h5 className="text-sm text-gray-600">Enter using:</h5>
          ...
          <div className="mt-2">
            {method === "email" ? (
              <input
                id="input"
                type="email"
                className="appearance-none w-full px-3 py-2 border-gray-500 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                required
              />
            ) : null}
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input
                  id="input"
                  type="number"
                  className="appearance-none w-full px-3 py-2 border-gray-500 rounded-md rounded-l-none shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                  required
                />
              </div>
            ) : null}
